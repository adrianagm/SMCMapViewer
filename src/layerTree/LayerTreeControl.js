 ...
 */
SMC.layertrees.LayerTreeControl = L.Control.extend({
/** @lends SMC.layertrees.LayerTreeControl# */
    ...
    _onLayerChange: function(e) {
        ...
        if (!obj) {
            ...
            if(e.layer.options && e.layer.options.label){
            	this.addOverlay(e.layer, e.layer.options.label, "<h2>Folder</h2>");
            }
...
SMC.layerTreeControl = function (baseLayers, overlays, options) {
	return new SMC.layertrees.LayerTreeControl(baseLayers, overlays, options);
};
